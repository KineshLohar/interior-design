    ...
    return (
        <div className="w-full min-h-screen p-4 py-10 sm:p-8 pb-24 sm:pt-16 sm:pb-24 md:p-12 md:py-24 lg:p-28 ">
            <div className="w-full flex flex-col items-center gap-4 text-center">
                <span className="reveal tracking-wide text-[#CBB57B] font-medium text-sm sm:text-base">OUR EXPERTISE</span>
                <h2 className="reveal w-full font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl transition-normal duration-300 -mt-2">
                    What Sets Us Apart
                </h2>
                <Separator
                    className="reveal min-h-1 max-w-40 rounded-full bg-[#CBB57B]"
                />
                <p className="reveal sm:max-w-xl md:max-w-2xl text-xs sm:text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic expedita distinctio quas, aspernatur corporis autem tenetur nobis odit architecto, nemo vel exercitationem consequuntur similique consectetur fugiat nesciunt ipsam eos soluta!</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 mt-12">
                {
                    features?.map(item => {
                        ...
                        return (
                            <div
                                key={item?.id}
                                className="reveal flex flex-col gap-3 items-stretch justify-center bg-neutral-900 p-8"
                            >
