...
export const AboutSection = () => {
    return (
        <section className="relative w-full flex flex-col-reverse gap-10 items-stretch justify-start md:flex-row md:items-stretch text-center bg-gradient-to-tl from-[#F4ECF7] via-[#E4D4C8] to-[#F4ECF7] text-black md:min-h-screen p-4 py-16 sm:p-8 pb-24 sm:pt-16 sm:pb-24 md:p-12 md:py-24 lg:p-24">
            <div className="reveal relative w-full md:w-6/12 h-[300px] min-[400px]:h-[400px] min-[450px]:h-[500px] md:h-[450px] transition-all duration-300 ">
                <Image
                    src="/background.jpeg"
            ...
            <div className="relative w-full md:w-6/12 md:min-h-full text-right flex flex-col justify-center">
                <h2 className="reveal font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6 xl transition-normal duration-300">
                    Get to Know Us
                </h2>
                <p className="reveal mt-4 font-lato text-neutral-800">
                ...
                <div className="reveal ml-auto flex justify-end items-center gap-4 sm:gap-6 mt-8 md:mt-12">
                    <Card
